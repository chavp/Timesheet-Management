Ext.define('TM.view.TaskTypeWindow', {
    extend: 'Ext.window.Window',
    xtype: 'tasktypewindow',
    width: 500,
    title: TextLabel.addTaskTypeText,
    resizable: false,
    closable: false,
    constrain: true,
    config: {
    ...
    initComponent: function () {
        ...
        var addAction = Ext.create('Ext.Action', {
            ...
            handler: function (widget, event) {
                ...
                var saveData = Ext.create('widget.tasktype', {
                    ID: vals.ID,
                    Name: vals.Name,
                    Order: vals.Order
                });
                ...
                Ext.Ajax.request({
                    url: paramsView.urlSaveTaskType,
    ...
    listeners: {
        close: function (panel, eOpts) {
            ...
            var form = self.down('form');
            if (form.isDirty()) {
                if (self.tasktypeStore) self.tasktypeStore.load();
            }
        }
    }
});